...
from .views import (
    job_list, job_detail, sign_up, log_in, home, 
    applicant, clients, our_services, about_us, 
    employer, profile, apply, register_user,  
    submit_application,  post_job,
    landing_page, list_agencies, update_security_companies, log_out, profile
)
...
urlpatterns = [
    ...
    path('home/job_list/', job_list, name='job_list'),  # Ensure this matches your view
    ...
    path('list_agencies/', list_agencies, name='list_agencies'), 
